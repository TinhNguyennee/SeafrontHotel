...
public class Menu3 extends javax.swing.JPanel {
    ...
    public Menu3() {
        ...
        jLabel1.setIcon(new ImageIcon(new ImageIcon(getClass().getResource("/Icon/logo4.png")).getImage().getScaledInstance(140, 100, Image.SCALE_SMOOTH)));
        init();
    }
    ...
    private void init() {
        ...
        listMenu1.addItem(new Model_Menu("3", "Loại Phòng", Model_Menu.MenuType.MENU));
